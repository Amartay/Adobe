...
incremental_params={'TGT1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_details'},
'TGT2_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_details_scd'},                    
# 'BKP_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_tmp.dim_agent_details_bkp_test'},  
'SRC_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_scd_stg'},
...
'CURRENT_QUARTER': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'Y'},
'TO_ADDR': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'tat80177@adobe.com,saimukhe@adobe.com'},
...
full_params={'TGT1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_details'},
'TGT2_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_details_scd'}, 
# 'BKP_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_tmp.dim_agent_details_bkp_test'},  
'SRC_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_scd_stg'},
'DIM_TEAM': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team'}, 
'DIM_DATE': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'ids_coredata.dim_date'},            
'FILE_PATH': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': '/FileStore/tables/B2B_phones/Dim_Agent_details/'},
'CURRENT_QUARTER': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'N'},
'TO_ADDR': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'tat80177@adobe.com,saimukhe@adobe.com'},
'FROM_ADDR': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'do-not-reply-dpaas-dbx@adobe.com'},
'Custom_Settings': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'set spark.sql.parquet.enableVectorizedReader=false,SET hive.warehouse.data.skiptrash=true'}}
