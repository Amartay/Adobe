...
incremental_params={'TGT1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abddash_summary'},
'STG1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.rtb_lookup_table'}, 
'RULES_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abdashbase_rules'}, 
'STG3_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team'},
'HISTORY_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abddash_historicals'},
'DIM_AGENT_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_details'}, 
'IB_FUNNEL_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.ib_manual'}, 
'QRF_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_qrf'}, 
'OAC_CALL_CHAT_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.vw_fact_oac_call_chat'},
'DIM_COUNTRY': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'ids_masterdata.dim_country'},
'CURRENT_QTR': {'Type': 'SQL', 'Dtype': 'QSTR', 'Value': '''select distinct fiscal_yr_and_qtr_desc from ids_coredata.dim_date where date_date = current_date()'''}, 
...
full_params={'TGT1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abddash_summary'},
'STG1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.rtb_lookup_table'}, 
'RULES_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abdashbase_rules'}, 
'STG3_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team'}, 
'HISTORY_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abddash_historicals'},
...
'OAC_CALL_CHAT_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.vw_fact_oac_call_chat'},
'DIM_COUNTRY': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'ids_masterdata.dim_country'}, 
'CURRENT_QTR': {'Type': 'STATIC', 'Dtype': 'QSTR', 'Value': '2023-Q3'}, 
'Custom_Settings': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'set spark.sql.parquet.enableVectorizedReader=false,SET hive.warehouse.data.skiptrash=true'}}
