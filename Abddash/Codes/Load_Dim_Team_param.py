...
incremental_params={'TGT1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team_test'},
'BKP_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team_bkp'}, 
'SRC_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team_stg'},
...
full_params={'TGT1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team_test'},
'BKP_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team_bkp'},
'SRC_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team_stg'}, 
'FILE_PATH': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': '/FileStore/tables/B2B_phones/Dim_team/'},
'TO_ADDR': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'tat80177@adobe.com'},
