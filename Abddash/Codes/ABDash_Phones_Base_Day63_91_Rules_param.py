...
'TGT_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abdashbase_rules'},   
# 'UAT_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abdashbase_purchase_cancel_rules'},  
'fiscal_yr_and_qtr_desc': {'Type': 'SQL', 'Dtype': 'QSTR', 'Value': '''select fiscal_yr_and_qtr_desc from ids_coredata.dim_date where date_date = (select date_add(current_date,-92))'''},  
...
'TGT_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abdashbase_rules'},
# 'UAT_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abdashbase_purchase_cancel_rules'},         
'fiscal_yr_and_qtr_desc': {'Type': 'STATIC', 'Dtype': 'QSTR', 'Value': '2023-Q3'},  
'Custom_Settings': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'set spark.sql.parquet.enableVectorizedReader=false,SET hive.warehouse.data.skiptrash=true'}}
