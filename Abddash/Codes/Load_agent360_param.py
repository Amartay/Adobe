...
incremental_params={'TGT1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.fact_abddash_rep_performance'},
...
'SRC_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_stg'},
'ABDASH_RULES': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abdashbase_rules'},
'DIM_TEAM': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team'},
'AGENT_DETAILS': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_details_scd'}, 
'AGENT_DETAILS_ACTIVE': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_details'}, 
'DATE_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'ids_coredata.dim_date'},   
'TMP_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.ABDashBase_tmp'},
'DIM_SUBSCRIPTION': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'csmb.vw_dim_subscription'},
'DIM_COUNTRY': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'ids_masterdata.dim_country'},
'FILE_PATH': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': '/FileStore/tables/B2B_phones/Dim_Agent_details/'},
...
full_params={'TGT1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.fact_abddash_rep_performance'},
'TO_DT': {'Type': 'STATIC', 'Dtype': 'QSTR', 'Value': '2023-09-01'},
'FROM_DT': {'Type': 'STATIC', 'Dtype': 'QSTR', 'Value': '2023-06-03'},
'BKP_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_details_bkp'},
'SRC_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_agent_stg'},
'ABDASH_RULES': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.abdashbase_rules'},
'DIM_TEAM': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.dim_team'},
