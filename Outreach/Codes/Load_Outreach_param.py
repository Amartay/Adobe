...
incremental_params={'TGT1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.outreach_base'},
'DIM_DATE': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'ids_coredata.dim_date'},
'FILE_PATH': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': '/FileStore/tables/B2B_phones/Dim_team/'},
...
'FROM_DT': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': '2024-02-29'},
'TO_DT': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': '2024-02-29'},
...
full_params={'TGT1_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.outreach_base'}, 
'DIM_DATE': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'ids_coredata.dim_date'},             
'FILE_PATH': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': '/FileStore/tables/B2B_phones/Dim_team/'},
'EVENTS': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'prospects,accounts'},
'FROM_DT': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': '2024-03-05'},
'TO_DT': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': '2024-03-05'},
'PAGE_SIZE': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': '500'},
'TO_ADDR': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'tat80177@adobe.com,saksangal@adobe.com'},
'FROM_ADDR': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'tat80177@adobe.com'},
