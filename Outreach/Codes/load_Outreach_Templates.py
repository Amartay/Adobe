...
class main() :
    def __init__(self):
        try :
             ...
             StructField('lastUsedAt', StringType(), True),
             ...
             StructField('relationship_contentCategoryMemberships_count', StringType(), True),
             ...
             itr_df = spark.sql("""
                                ...
                                from {OUTREACH_BASE} 
                                where event = 'templates' and string(to_date(from_dt))  between '{from_dt}' and '{to_dt}'
             ...
             for i in range(1,max_itr+1):
                 ...
                 df_data_explode['data_explode']['attributes']['bounceCount'].cast(StringType()).alias('bounceCount'),
                 df_data_explode['data_explode']['attributes']['clickCount'].cast(StringType()).alias('clickCount'),
                 df_data_explode['data_explode']['attributes']['createdAt'].cast(StringType()).alias('createdAt_tbl'),
                 df_data_explode['data_explode']['attributes']['deliverCount'].cast(StringType()).alias('deliverCount'),
                 df_data_explode['data_explode']['attributes']['failureCount'].cast(StringType()).alias('failureCount'),
                 df_data_explode['data_explode']['attributes']['lastUsedAt'].cast(StringType()).alias('lastUsedAt'),
                 df_data_explode['data_explode']['attributes']['negativeReplyCount'].cast(StringType()).alias('negativeReplyCount'),
                 df_data_explode['data_explode']['attributes']['neutralReplyCount'].cast(StringType()).alias('neutralReplyCount'),
                 df_data_explode['data_explode']['attributes']['openCount'].cast(StringType()).alias('openCount'),
                 df_data_explode['data_explode']['attributes']['optOutCount'].cast(StringType()).alias('optOutCount'),
                 df_data_explode['data_explode']['attributes']['positiveReplyCount'].cast(StringType()).alias('positiveReplyCount'),
                 df_data_explode['data_explode']['attributes']['replyCount'].cast(StringType()).alias('replyCount'),
                 df_data_explode['data_explode']['attributes']['scheduleCount'].cast(StringType()).alias('scheduleCount'),
                 df_data_explode['data_explode']['attributes']['subject'].cast(StringType()).alias('subject'),
                 ...
                 get_json_object(to_json(struct(df_data_explode['data_explode']['relationships']['contentCategoryMemberships'])),'$.contentCategoryMemberships.meta.count').cast(StringType()).alias('relationship_contentCategoryMemberships_count'),
