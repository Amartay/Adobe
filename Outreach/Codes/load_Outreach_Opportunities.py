...
class main() :
    def __init__(self):
        try :
             ...
             StructField('externalCreatedAt', StringType(), True),
             StructField('name', StringType(), True),
             StructField('nextStep', StringType(), True),
             StructField('opportunityType', StringType(), True),
             StructField('updatedAt', StringType(), True),
             StructField('relationship_account_id', StringType(), True),
             StructField('relationship_account_type', StringType(), True),
             StructField('relationship_assignedTeams_count', StringType(), True),
             StructField('relationship_assignedUsers_id', StringType(), True),
             StructField('relationship_assignedUsers_count', StringType(), True),
             StructField('relationship_defaultPluginMapping_id', StringType(), True),
             StructField('relationship_externalCreator_id', StringType(), True),
             StructField('relationship_favorites_count', StringType(), True),
             StructField('relationship_opportunityHealthFactors_count', StringType(), True),
             StructField('relationship_opportunityStage_id', StringType(), True),
             ...
             itr_df = spark.sql("""
                                ...
                                from {OUTREACH_BASE} 
                                where event = 'opportunities' and string(to_date(from_dt))  between '{from_dt}' and '{to_dt}'
             ...
             for i in range(1,max_itr+1):
                 ...
                 df_data_explode_level1 = df_data_explode.withColumn('assignedUsers',explode_outer(df_data_explode['data_explode']['relationships']['assignedUsers']['data']))

                 df_final = df_data_explode_level1.select(
                 df_data_explode_level1['data_explode']['id'].cast(StringType()).alias('id'),
                 df_data_explode_level1['data_explode']['attributes']['closeDate'].cast(StringType()).alias('closeDate'),
                 df_data_explode_level1['data_explode']['attributes']['createdAt'].cast(StringType()).alias('createdAt_tbl'),
                 df_data_explode_level1['data_explode']['attributes']['currencyType'].cast(StringType()).alias('currencyType'),
                 df_data_explode_level1['data_explode']['attributes']['custom3'].cast(StringType()).alias('custom3'),
                 df_data_explode_level1['data_explode']['attributes']['externalCreatedAt'].cast(StringType()).alias('externalCreatedAt'),
                 df_data_explode_level1['data_explode']['attributes']['name'].cast(StringType()).alias('name'),
                 df_data_explode_level1['data_explode']['attributes']['nextStep'].cast(StringType()).alias('nextStep'),
                 df_data_explode_level1['data_explode']['attributes']['opportunityType'].cast(StringType()).alias('opportunityType'),
                 ...
                 get_json_object(to_json(struct(df_data_explode_level1['data_explode']['relationships']['account'])),'$.account.data.type').cast(StringType()).alias('relationship_account_type'),
                 get_json_object(to_json(struct(df_data_explode_level1['data_explode']['relationships']['assignedTeams'])),'$.assignedTeams.meta.count').cast(StringType()).alias('relationship_assignedTeams_count'),
                 get_json_object(to_json(struct(df_data_explode_level1['assignedUsers'])),'$.assignedUsers.id').cast(StringType()).alias('relationship_assignedUsers_id'),
                 get_json_object(to_json(struct(df_data_explode_level1['data_explode']['relationships']['assignedUsers'])),'$.assignedUsers.meta.count').cast(StringType()).alias('relationship_assignedUsers_count'),
                 get_json_object(to_json(struct(df_data_explode_level1['data_explode']['relationships']['defaultPluginMapping'])),'$.defaultPluginMapping.data.id').cast(StringType()).alias('relationship_defaultPluginMapping_id'),
                 get_json_object(to_json(struct(df_data_explode_level1['data_explode']['relationships']['externalCreator'])),'$.externalCreator.data.id').cast(StringType()).alias('relationship_externalCreator_id'),
                 get_json_object(to_json(struct(df_data_explode_level1['data_explode']['relationships']['favorites'])),'$.favorites.meta.count').cast(StringType()).alias('relationship_favorites_count'),
                 get_json_object(to_json(struct(df_data_explode_level1['data_explode']['relationships']['opportunityHealthFactors'])),'$.opportunityHealthFactors.meta.count').cast(StringType()).alias('relationship_opportunityHealthFactors_count'),
                 get_json_object(to_json(struct(df_data_explode_level1['data_explode']['relationships']['opportunityStage'])),'$.opportunityStage.data.id').cast(StringType()).alias('relationship_opportunityStage_id'),
                 ...
                 get_json_object(to_json(struct(df_data_explode_level1['data_explode']['relationships']['stage'])),'$.stage.data.id').cast(StringType()).alias('relationship_stage_id'),
