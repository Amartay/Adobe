...
incremental_params={'TGT_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.Outreach_Users'},
...
full_params={'TGT_TBL': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.Outreach_Users'},
'OUTREACH_BASE': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'b2b_phones.outreach_base'}, 
'DIM_DATE': {'Type': 'STATIC', 'Dtype': 'STR', 'Value': 'ids_coredata.dim_date'},             
